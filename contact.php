											...
											<div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-3 vc_col-md-6 vc_col-xs-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="eltdf-section-title-holder   eltdf-section-title-appeared" style="text-align: center">
															<div class="eltdf-st-inner">
																<h3 class="eltdf-st-title" style="color: #4d504a">Email </h3>
																<p class="eltdf-st-subtitle" style="text-transform: none;color: #72726c">
																	<span>info@glintzphotography.org <a class="eltdf-st-subtitle-link" href="mailto:info@glintzphotography.org" target="_blank"></a></span>
																</p>
															</div>
														</div>
											...
											<div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-3 vc_col-md-6 vc_col-xs-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="eltdf-section-title-holder   eltdf-section-title-appeared" style="text-align: center">
															<div class="eltdf-st-inner">
																<h3 class="eltdf-st-title" style="color: #4d504a">Address </h3>
																<p class="eltdf-st-subtitle" style="text-transform: none;color: #72726c">
																	<span>Lagos, Nigeria <a class="eltdf-st-subtitle-link" href="https://www.google.com/maps/place/Uniqlo+Soho/@40.7190772,-74.001693,16z/data=!4m13!1m7!3m6!1s0x89c24fa5d33f083b:0xc80b8f06e177fe62!2sNew+York,+NY,+USA!3b1!8m2!3d40.7127753!4d-74.0059728!3m4!1s0x89c2598edb6242d3:0x4ae291a9ff31e800!8m2!3d40.7234983!4d-73.9982012" target="_blank"></a></span>
																</p>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 32px">
																...
																<div class="wpb_wrapper">
																	<div class="wpb_widgetised_column wpb_content_element">
																		<div class="wpb_wrapper">
																			...
																			<span>FB</span></a>
																			<a class="eltdf-social-icon-widget-holder eltdf-icon-has-hover" style="color: #84847c;;margin: 27px 0 0 0;" href="https://www.instagram.com/glintz_photography/" target="_blank" rel="noopener noreferrer"><span>IN</span></a>
...
<section class="eltdf-side-menu ps ps--active-y">
	...
	<div id="media_image-6" class="widget eltdf-sidearea widget_media_image">
		<a href="https://glintzphotography.org/">
			<img width="96" height="91" src="./images/glintz-logo-black.png" class="image wp-image-2893  attachment-full size-full" alt="m" style="max-width: 100%; height: auto;">
		</a>
	</div>
	<div class="widget eltdf-separator-widget">
		<div class="eltdf-separator-holder clearfix  eltdf-separator-center eltdf-separator-normal">
...
<div class="elfsight-app-2cfe4e2b-64d0-431b-a343-973fae233446"></div>
	...
	<div class="widget eltdf-custom-font-widget">
		<h2 class="eltdf-custom-font-holder  eltdf-cf-6786   " style="font-family: Cormorant Garamond;font-size: 22px;line-height: 24px;font-weight: 300;letter-spacing: .15em;text-transform: uppercase;text-align: center;color: #ffffff;margin: 0 0 0px 0" data-item-class="eltdf-cf-6786">Follow Us
		</h2>
	</div>
	<div class="widget eltdf-separator-widget">
		<div class="eltdf-separator-holder clearfix  eltdf-separator-center eltdf-separator-normal">
	...
	<div class="widget eltdf-custom-font-widget">
		<h2 class="eltdf-custom-font-holder  eltdf-cf-2418   " style="font-family: Cormorant Garamond,serif;font-size: 21px;line-height: 1.772727272727273em;font-weight: 400;font-style: italic;letter-spacing: 0px;text-transform: capitalize;text-align: center;color: #afafa5" data-item-class="eltdf-cf-2418">
