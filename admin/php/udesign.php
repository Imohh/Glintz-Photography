...
$id=$_POST['id'];
$query="SELECT * FROM ui_design WHERE id='$id'";
...
if(isset($_GET['del'])){
    $id=$_GET['del'];
    $query="DELETE FROM ui_design WHERE id='$id'";
    $queryrun=mysqli_query($db,$query);
if($queryrun){
    header("location:../?edituidesign=true#done");
}
...
$query="INSERT INTO ui_design (projectname,projectpic,projectlink) ";
