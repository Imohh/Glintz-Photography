...
?>
         ...
         <form method="post" action="php/udocumentary.php" enctype="multipart/form-data">
  <div class="form-row">
  ...
  <div class="custom-file">
    ...
    <div class="form-group col-md-2 ml-auto">
        <input type="submit" name="addtodocumentary" class="btn btn-primary" value="Add To Documentary">
    </div>
    ...
    <label class="custom-file-label" for="projectpic">Choose Pic...</label>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" name="pupdate" value="Update">
         ...
         <a href="php/udocumentary.php?del=<?=$data2['id']?>"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
  Delete
             </button></a></td>
            </tr>            
         <?php $count++;
